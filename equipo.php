...
<body>
    ...
    <section class="w-75 m-auto paddint_top_2rem">
        <div class="row justify-content-center">
            <div class="col-lg-1">
                <center><img width="120" class="p-2" src="img/logo3.png" alt=""></center>
            </div>
    ...
    <section class="w-75 m-auto">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3">
                <div class="tar float-left m-2" data-toggle="modal" data-target=".bd-example-modal-sm-3">
