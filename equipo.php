...
<body>
    ...
    <section class="w-75 m-auto paddint_top_2rem">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-7">
                <p class="p-2">El coaching es un arte y como tal se perfecciona con el tiempo y la práctica. Por ello <strong class="color_azul_human">todos nuestros formadores son coaches que tienen años de experiencia profesional</strong> y han acompañado a cientos de personas en procesos de desarrollo personal y laboral. Nuestra metodología asegura que puedas aprender de su trayectoria.</p>
            </div>
        </div>
    </section>
