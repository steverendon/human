<div class="start-form position-fixed text-center content-form">
  <div class="bg-white rounded">
    ...
    <center><p class="h5 text-uppercase font-weight-bold w-75"><b><span style="font-size:1.1em; color: #8EB7C1">certificacion</span><br><span style="font-size:0.8em"> en coaching profesional</span></b></p><center>
    <p class="m-2 w-75 m-auto" style="font-size: 0.8em;">Conoce más sobre nuestro programa de formación, déjanos tus datos.</p>
