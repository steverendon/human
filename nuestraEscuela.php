        ...
        <table class="w-100">
            <tr>
                ...
                <td>
                    ...
                    <p class="text-uppercase pl-2 ml-4 font-weight-bold"><strong class="color_azul_human">VER HUMAN GROWTH CONSULTORIA</strong> <img src="img/arrow.png" alt=""></p>
                </td>
            </tr>
        ...
        <table class="w-100">
            <tr>
                ...
                <td>
                    ...
                    <div class="ml-4 pl-2">
                        <button class="my-button">nuestro equipo</button>
                    </div>
                </td>
            </tr>
        </table>

        <p class="font-weight-bold mt-5 fs_24px"><strong>¿Qué esperamos que logres?</strong></p>
